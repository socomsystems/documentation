...
* Remote Subfolder, the FTP directory to mount in Nextcloud. cyfrSpaces defaults 
...
Optionally, cyfrSpaces can use FTPS (FTP over SSL) by checking **Secure ftps://**. 
...
.. figure:: images/ftp.png
   :alt: cyfrSpaces GUI FTP configuration. 
